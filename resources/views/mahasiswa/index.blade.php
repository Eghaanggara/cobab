...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
      <a class="navbar-brand" href="/">Laravel - Egha anggara arihta Sitepu 2109020190 Teknologi Informasi E1</a>
            ...
            <tbody>
              @foreach ($mahasiswa as $m)
                <tr>
                  ...
                  <td>{{ $m->alamat }}</td>
                  <td>
                    <a href="{{url('mahasiswa/'.$m->npm.'/edit')}}" class="btn btn-warning btn-sm"> Ubah</a>
                    <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('mahasiswa/'.$m->npm) }}" method="post">
                      @csrf 
                      @method('DELETE')
